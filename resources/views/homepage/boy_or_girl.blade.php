    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mt-4" style="text-align: center;font-size: 16px;">
                <p style="font-size: 18px;font-weight: bold;">به مجموعه مدارس دانش و آفرینش خوش آمدید </p>
                <p style="font-size: 13px;">لطفا جهت دسترسی به مدرسه مورد نظر روی گزینه کلیک کنید</p>
            </div>
        </div>
        <div class="row">
