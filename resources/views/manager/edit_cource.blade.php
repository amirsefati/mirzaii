            ...
            <div class="card-body">
                <ul>
                    @foreach($list_course_1 as $course_1)
                        <li>{{$course_1->title}} - {{$course_1->desc}}</li>
                    @endforeach
                </ul>      
            </div>
        </div>
            ...
            <div class="card-body">
                <ul>
                    @foreach($list_course_2 as $course_2)
                        <li>{{$course_2->title}} - {{$course_2->desc}}</li>
                    @endforeach
                </ul>      
            </div>
        </div>
            ...
            <div class="card-body">
                <ul>
                    @foreach($list_course_3 as $course_3)
                        <li>{{$course_3->title}} - {{$course_3->desc}}</li>
                    @endforeach
                </ul>      
            </div>
        </div>
            ...
            <div class="card-body">
                <ul>
                    @foreach($list_course_4 as $course_4)
                        <li>{{$course_4->title}} - {{$course_4->desc}}</li>
                    @endforeach
                </ul>      
            </div>
        </div>
            ...
            <div class="card-body">
                <ul>
                    @foreach($list_course_5 as $course_5)
                        <li>{{$course_5->title}} - {{$course_5->desc}}</li>
                    @endforeach
                </ul>      
            </div>
        </div>
            ...
            <div class="card-body">
                <ul>
                    @foreach($list_course_6 as $course_6)
                        <li>{{$course_6->title}} - {{$course_6->desc}}</li>
                    @endforeach
                </ul>      
            </div>
        </div>
